...
# UI function
ui <- fluidPage(
  titlePanel("DE & GSEA Analysis App"),
  sidebarLayout(
    sidebarPanel(
      tabsetPanel(
        tabPanel("Data Input", 
                 fileInput("rna", "Select RNA file"),
                 fileInput("clin", "Select clinical data file"),
